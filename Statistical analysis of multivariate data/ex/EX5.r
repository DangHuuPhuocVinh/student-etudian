...
###Q2
plot(X,Y) #Non, parce que plusieurs le cout direct pour une même valeur de nombre de mois
###Q3
droite5<-lm(Y~X)
...
resid(droite5)
###Q9
summary(droite5) ##R-squared:  0.8154. Plus coefficient de détermination est proche de 1, 
        ##plus les données sont alignées sur la droite de régression.
